// Navogation bar effects on scroll
...
// Common reveal options to creat reveal animations
...
// ScrollReveal().reveal('.media-icons i, .contact-left li', { delay: 300, origin: 'left', interval: 150});
...
// ScrollReveal().reveal('.experiance-card, .service-card, education, .portfolio .img-card', { delay: 800, origin: 'bottom', interval: 150});
